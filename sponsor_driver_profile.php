...
<?php 
  ...
  $driver_sponsor_profile = $mysqli_si->query("SELECT * from sponsor_drivers WHERE sponsor_company = ? AND driver_id = ?", [$user->getValue('sponsor_company'), $user_driver->uid])->fetch("assoc");
?>
