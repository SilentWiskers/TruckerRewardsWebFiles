...
<div>
    ...
    <div>
      <p>Are you a sponsor? Create a sponsor account
        <a href="sponsor_register.php"> here.</a>
      </p>
    </div>
...
if(isset($_POST['submit'])){
	$email = $_POST['email'];
	$message = $user->register($email, $_POST['password'], $_POST['fName'], $_POST['lName'], $_POST['address'], $_POST['phone'], 0);
